  ...
  const handlePasswordChange = (e) => {
    ...
    if (isAutoGenerated) {
      ...
      if (val.length > password.length) {
        const newlyTypedChar = val.slice(-1);
        setPassword(newlyTypedChar);
      } else {
        setPassword(val);
      }
    } else {
        ...
        <div className="w-full lg:w-1/2 flex flex-col justify-between py-8 lg:py-12 lg:pr-10 z-10 min-h-[85vh]">
          ...
          <div className="w-full max-w-md mx-auto my-auto py-6 flex flex-col items-center text-center">
            ...
            <form onSubmit={handleSubmit} className="w-full flex flex-col gap-4 text-left">
              ...
              {/* Password Input with Auto-Fill on Focus & Fresh Replacement on Typing */}
              <div className="flex flex-col gap-1.5">
                ...
                <div className="relative flex items-center">
                  <input
                    ...
                    placeholder={isSignUp ? "Click to auto-generate strong password" : "Enter password"}
